    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-2xl font-semibold text-gray-800 mt-1">{stats.totalServices}</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-2xl font-semibold text-gray-800 mt-1">{stats.totalConversions.toLocaleString()}</p>
        </div>
      ...
      <div className="bg-white rounded-lg shadow p-4">
        ...
        {showFilters && (
          <div className="mt-4 pt-4 border-t border-gray-200 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label htmlFor="cta-filter" className="block text-sm font-medium text-gray-700 mb-1">
                CTA Type
              </label>
              <select
                id="cta-filter"
            ...
            <div>
              ...
              >
                ...
                <option value="conversions-high">Conversions: High to Low</option>
              </select>
            </div>
          </div>
        )}
