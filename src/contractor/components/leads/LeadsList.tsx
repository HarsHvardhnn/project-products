...
export const LeadsList: React.FC<LeadsListProps> = ({ searchTerm, statusFilter }) => {
  ...
  const [leads] = useState<Lead[]>([
    {
      ...
      status: 'new',
      notes: 'Interested in modern design, wants to start in 3 months',
    ...
    },
    {
      ...
      phone: '(555) 456-7890',
      address: '321 Cedar Ave, Portland, OR 97204',
      projectType: 'Bathroom Renovation',
      budget: '$15,000 - $25,000',
      status: 'contacted',
      notes: 'Follow up needed regarding material selection',
