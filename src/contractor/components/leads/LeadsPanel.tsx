...
export const LeadsPanel: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'customers' | 'leads' | 'meetings'>('customers');
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex-1 flex">
              ...
              <input
                type="text"
                placeholder={`Search ${activeTab === 'customers' ? 'customers' : 'leads'}...`}
                value={searchTerm}
      ...
      <div className="bg-white rounded-lg shadow">
        {activeTab === 'customers' ? (
          <CustomersList searchTerm={searchTerm} statusFilter={statusFilter} />
        ) : activeTab === 'leads' ? (
          <LeadsList searchTerm={searchTerm} statusFilter={statusFilter} />
        ) : (
          <MeetingsList />
        )}
      </div>
