...
export const TaskForm: React.FC<TaskFormProps> = ({ 
  ...
  // Get standard tasks and filter out existing ones
  const standardTasks = getStandardTasks('Interior Renovation & Remodeling', 'Kitchen Remodeling')
    .filter(standardTask => !existingTasks.some(existingTask => 
      existingTask.title.toLowerCase() === standardTask.title.toLowerCase()
    ));
