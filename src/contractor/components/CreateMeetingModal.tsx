...
import { Copy, X, Calendar, Clock, Video, Link as LinkIcon, Share2, Mail, Phone } from 'lucide-react';
...
export const CreateMeetingModal: React.FC<CreateMeetingModalProps> = ({
  ...
  const generateMeetingLink = async () => {
    ...
    try {
      ...
      setMeetingLink(`http/meeting/${data.roomId}`);
    } catch (error) {
      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900">Create Instant Meeting</h3>
          ...
          <div className="mb-6 space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">5-Minute Meeting</p>
                <p className="text-sm text-gray-500">Quick consultation to understand needs</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Instant Availability</p>
                <p className="text-sm text-gray-500">No scheduling required - start immediately</p>
              </div>
            </div>
          </div>
