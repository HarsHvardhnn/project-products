...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gray-100">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative" ref={userDropdownRef}>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-700 hidden md:block">Josh Householder</span>
      ...
      {/* Main Content */}
      <div className="flex">
        <SideNavigation activePanel={activePanel} onPanelChange={onPanelChange} />
