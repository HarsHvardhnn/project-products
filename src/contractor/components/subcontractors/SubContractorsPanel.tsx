...
export const SubContractorsPanel: React.FC = () => {
  ...
  const [subcontractors, setSubcontractors] = useState<Subcontractor[]>([
    {
      ...
      email: 'michael@eliteelectrical.com',
      phone: '(555) 123-4567',
      address: '789 Industrial Ave, Portland, OR 97201',
      serviceTypes: ['Electrical', 'Smart Home Installation'],
      serviceAreas: ['Portland Metro', 'Vancouver WA'],
      status: 'active',
    ...
    },
    {
      ...
      phone: '(555) 234-5678',
      address: '456 Commerce St, Portland, OR 97202',
      serviceTypes: ['Plumbing', 'Water Heater Installation'],
      serviceAreas: ['Portland Metro', 'Salem'],
      status: 'active',
    ...
    },
    {
      id: 'sub3',
      name: 'David Wilson',
      company: 'Wilson HVAC Solutions',
      email: 'david@wilsonhvac.com',
      phone: '(555) 345-6789',
      address: '123 Contractor Lane, Portland, OR 97203',
      serviceTypes: ['HVAC', 'Ventilation'],
      serviceAreas: ['Portland Metro', 'Beaverton'],
      status: 'pending'
    }
  ]);
  ...
  const handleAddSubcontractor = (newSubcontractor: any) => {
    const subcontractor: Subcontractor = {
      id: `sub${subcontractors.length + 1}`,
      name: newSubcontractor.name,
      company: newSubcontractor.name,
      email: newSubcontractor.email,
      phone: newSubcontractor.phone,
      address: newSubcontractor.location,
      serviceTypes: newSubcontractor.serviceTypes,
      serviceAreas: ['Portland Metro'],
      status: 'pending'
    };
