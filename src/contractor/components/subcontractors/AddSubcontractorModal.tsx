                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`block w-full rounded-none rounded-r-md shadow-sm sm:text-sm ${
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Service Types *
                      {errors.serviceTypes && <span className="ml-2 text-xs text-red-500">{errors.serviceTypes}</span>}
                    </label>
